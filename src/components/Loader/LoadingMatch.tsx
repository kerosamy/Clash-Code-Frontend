...
const LoadingMatch = ({ matchType, invitedUser, notificationId, onCancel }: LoadingMatchProps) => {
  ...
  const getLoadingMessage = () => {
    if (matchType === "friend") {
      return invitedUser ? `Waiting for ${invitedUser}'s acceptance` : "Waiting for acceptance";
    }
  ...
  return (
    <div className="bg-background flex flex-col flex-1 items-center justify-center min-h-screen gap-8">
      <div className="flex flex-col items-center">
        <svg
          ...
          className="mb-8 fade-in-scale elegant-glow"
        >
          <defs>
            <linearGradient
              id="paint0_linear_match"
              x1="63"
              y1="23"
              x2="63"
              y2="36"
            ...
            <linearGradient id="shimmerGradient_match" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <g style={{ animation: "slideInLeft 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.05s backwards" }}>
            <path
          ...
          <g style={{ animation: "slideInLeft 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.1s backwards" }}>
            <path
          ...
          <g style={{ animation: "slideInLeft 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.15s backwards" }}>
            <path
          ...
          <g style={{ animation: "slideInLeft 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s backwards" }}>
            <path
              ...
              fill="url(#paint0_linear_match)"
              stroke="url(#shimmerGradient_match)"
              strokeWidth="1"
            />
          </g>

          <g style={{ animation: "slideInRight 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.25s backwards" }}>
            <path
              ...
              fill="url(#paint1_linear_match)"
              stroke="url(#shimmerGradient_match)"
              strokeWidth="1"
            />
          </g>

          <g style={{ animation: "slideInRight 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.3s backwards" }}>
            <path
        ...
        <div className="flex items-center gap-1 mb-6">
          <span className="text-orange text-3xl font-anta tracking-wide">
            {getLoadingMessage()}
          </span>
        ...
        <div className="mb-8 pulse">
          <div className="text-orange text-5xl font-anta font-bold tracking-wider">
